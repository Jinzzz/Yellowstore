            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="regular_price"   id="regular_price" value="{{old('regular_price',$product->product_price)}}" placeholder="Regular Price">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="sale_price"  id="sale_price" value="{{old('sale_price',$product->product_price_offer)}}" placeholder="Sale Price">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                          <label class="form-label">Min Stock *</label>
                           <select required name="min_stock" id="min_stock" class="form-control"  >
                                 ...
                                 @for ($i = 0; $i < 21; $i++)
                                    <option {{old('min_stock',$product->stock_count) == $i ? 'selected':''}} value="{{$i}}">{{$i}}</option>
                                 @endfor
                            </select>
                        </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="product_cat_id" required id="category" class="form-control"  >
                                 <option value="{{$product->product_cat_id}}">{{$product->categories['category_name']}}</option>
                            </select>
                        </div>
                     </div>
