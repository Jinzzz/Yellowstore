                        ...
                        <div class="form-group">
                            <select name="delivery_boy_id"  class="attr_value form-control" >
                              ...
                              @foreach ($delivery_boys as $data)
                                 <option value="{{$data->delivery_boy_id}}">{{ $data->delivery_boy_name}}</option>
                              @endforeach
                            </select>
                        </div>
                   </div>
                   @endif
                   <div class=" @if($order->payment_type_id == 2) col-md-4 @else col-md-8  @endif">
                        <div class="form-group">
                                    ...
                                    @foreach ($order_items as $order_item)
                                       <tr>
                                          <td>
                                              <table>
                                                <tr>
                                                   <td><img src="{{asset('/assets/uploads/products/base_product/base_image/'.@$order_item->product->product_base_image)}}"  width="50" ></td>
                                          ...
                                          <td>
                                             <input type="hidden" name="product[{{@$order_item->product_id}}]" value=0>
                                             <input type="checkbox" name="product[{{@$order_item->product_id}}]" value=1>
                                          </td>
                                       </tr>
                                    @endforeach
