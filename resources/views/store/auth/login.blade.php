                     ...
                     <form method="POST" action="{{ route('store_login') }} ">
                        ...
                        <div class="wrap-input100 validate-input">
                           ...
                           @enderror --}}
                            ...
                            <input class="input100" id="store_mobile" type="username" name="store_mobile" placeholder="Mobile Number" value="{{ old('store_mobile') }}" required autocomplete="store_mobile" >
                           @error('username')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
