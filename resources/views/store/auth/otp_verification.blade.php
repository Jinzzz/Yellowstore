                  ...
                  <div class="wrap-login100 p-6" style="width:400px;">
                    ...
                    @endif
                        ...
                        {{-- <div class="container-login100-form-btn">
                            <a onclick="return confirm('Do you want to Resend OTP?');"
                       href="{{url('store/registration/otp_verify/resend_otp/'.$stores->store_id)}}" class="login100-form-btn btn-primary">Resend OTP</a>
