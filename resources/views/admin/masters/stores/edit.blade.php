       ...
       @if ($message = Session::get('status'))
         ...
         <div class="card-body">
            ...
            <div class="col-lg-12">
              ...
              @endif
               <form id="myForm" action="{{route('admin.update_store',$store->store_id)}}" method="POST"
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input required type="text" class="form-control" name="store_place" value="{{old('store_place',$store->place)}}" placeholder="Store Place">
                           </div>
                     </div>
 ...
 @if (auth()->user()->user_role_id == 0)
                  <div class="col-md-6">
                    <div class="form-group">
                          ...
                          <input type="number"  required name="store_commision_amount" step="0.1" class="form-control" placeholder="Store Commision Amount (Monthly) "  value="{{old('store_commision_amount',$store->store_commision_amount)}}">
                    </div>
                     </div>
                   ...
                   <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number"  required name="store_commision_percentage"  step="0.1" class="form-control" value="{{old('store_commision_percentage',$store->store_commision_percentage)}}" placeholder="Store Commission Percentage (Per Order)" value="{{old('store_commision_percentage')}}">
                        </div>
                     </div>
@endif
 ...
 <div class="col-md-6">
                    <div class="form-group">
                     <label id="passlabel" class="form-label">Password </label>
                          <input type="Password" onkeyup="validatePassLength()"  id="password"  name="password" class="form-control" placeholder=" Password" value="{{old('password')}}">
