  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
                   ...
                   <label class="form-label"> Password </label>
                            <input class="form-control" type="password" onkeyup="validatePassLength()" name="delivery_boy_password" value="{{old('delivery_boy_password')}}" placeholder="Password" id="password" type="password"  autocomplete="current-password">
