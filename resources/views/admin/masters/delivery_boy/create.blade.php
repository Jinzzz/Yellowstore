               ...
               <form id="myForm" action="{{route('admin.store_delivery_boy')}}" method="POST"
                  ...
                  <div class="row">
                   ...
                   <label class="form-label"> Password *</label>
                            <input class="form-control" type="password" onkeyup="validatePassLength()" name="delivery_boy_password" value="{{old('delivery_boy_password')}}" placeholder="Password" id="password" type="password" required autocomplete="current-password">
