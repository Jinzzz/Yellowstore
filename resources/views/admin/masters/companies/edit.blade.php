                     ...
                     <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control" name="company_pincode" value="{{old('company_pincode',$company->company_pincode)}}" placeholder="company Pincode">
                        </div>
                          </div>
                    ...
                    <input type="file"  class="form-control" name="company_logo" accept="image/x-png,image/jpg,image/jpeg"  value="{{old('company,$company->company_logo')}}" placeholder="company Logo">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="Password" onkeyup="validatePassLength()" id="password"  name="company_password" class="form-control" placeholder="Password" value="{{old('company_password')}}">
