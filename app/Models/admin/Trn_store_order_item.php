...
class Trn_store_order_item extends Model
{
    ...
    protected $fillable = [
    					    'order_item_id','product_varient_id','customer_id','store_id','delivery_boy_id','store_commision_percentage','cart_status','quantity','unit_price','total_amount','delivery_status','discount_percentage','payment_type_id','order_date','pay_date','delivery_date',
