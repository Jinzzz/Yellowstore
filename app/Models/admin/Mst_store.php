...
class Mst_store extends Authenticatable
{
    ...
    protected $fillable = [
    					    'store_id','store_name','store_name_slug',
                            'store_contact_person_name','store_contact_person_phone_number','store_contact_number_2','store_website_link','store_pincode','store_primary_address','email','store_added_by','business_type_id','store_commision_percentage','store_username','password','store_account_status',
                            'store_country_id',
                            'store_state_id',
                            'store_district_id',
                            'remember_token',
                            'subadmin_id','place','town','store_commision_amount'
