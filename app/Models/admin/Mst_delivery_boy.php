...
class Mst_delivery_boy extends Model
{

	protected $table = "mst_delivery_boys";
   protected $primaryKey = "delivery_boy_id";

    protected $fillable = ['delivery_boy_id', 'town_id' ,'delivery_boy_name','delivery_boy_mobile','delivery_boy_email','delivery_boy_image','delivery_boy_address','vehicle_number','vehicle_type_id','delivery_boy_availability_id','delivery_boy_username','delivery_boy_password','country_id','state_id','district_id','store_id','delivery_boy_status','delivery_boy_commision_amount'
							];
