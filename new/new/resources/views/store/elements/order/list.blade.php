            ...
            <div class="table-responsive">
               <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                  ...
                  <tbody>
                    ...
                    @php
                    $url = url('store/product_invoice/pdf/'.Crypt::encryptString($order->order_id));
...
<br>
                      ...
                      <a class="btn btn-sm btn-success" target="_blank" href="https://api.whatsapp.com/send?phone=+91{{$order->customer->customer_mobile_number}}&text={!!$msg!!}" data-action="share/whatsapp/share">Share Invoice Whatsapp</a>
