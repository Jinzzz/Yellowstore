                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="agency_pincode" name="agency_pincode" value="{{old('agency_pincode',$agency->agency_pincode)}}" placeholder="agency Pincode">
                        </div>
                         </div>
                       ...
                       <option {{old('business_type_id',$agency->business_type_id) == $key->business_type_id ? 'selected':''}} value="{{$key->business_type_id}}"> {{$key->business_type_name }} </option>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="Password" onkeyup="validatePassLength()" id="password"  name="agency_password" class="form-control" placeholder="Password" value="{{old('agency_password')}}">
