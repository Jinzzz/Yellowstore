                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" required class="form-control" name="company_pincode" value="{{old('company_pincode')}}" placeholder="Pincode">
                        </div>
                         </div>
                       ...
                       <label class="form-label">Company Logo [in png, jpeg or jpg]</label>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="Password" onkeyup="validatePassLength()" id="password" required="" name="company_password" class="form-control" placeholder="Password" value="{{old('company_password')}}">
