...
class ProductController extends Controller
{
    ...
    public function listGlobalProducts()
    {
        ...
        $global_product = Mst_GlobalProducts::all();
    ...
    public function editGlobalProduct($global_product_id)
    {
        ...
        return view('admin.masters.global_product.edit',compact('business_types','agencies','colors','tax','attr_groups','product_images','product','global_product_id','pageTitle'));
    }
    ...
    public function viewGlobalProduct(Request $request,$global_product_id)
    {
        ...
        return view('admin.masters.global_product.view',compact('product_images','product','global_product_id','pageTitle'));
    }
